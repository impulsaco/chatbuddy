...
const placesList = lang => {
  ...
  function consolidateWordSets(
    ...
    verbsTranslations,
    prepositionsTranslations,
    nounsRomanized,
    subjectsRomanized,
    verbsRomanized,
    prepositionsRomanized
  ) {
    const words = [];
    ...
    for (let i = 0; i < prepositions.length; i++) {
      words.push({
        ...
        word: prepositions[i],
        type: "preposition",
        translation: prepositionsTranslations[i],
        romanized: prepositionsRomanized && prepositionsRomanized[i],
      });
    }
