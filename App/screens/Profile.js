...
// User profile, Accounts, sign out.
// Show user profile picture, user name.
// Settings (dark mode, general, preferences).
// Help & Feedback, Privacy Policy, Terms of service.
...
import {
  ...
  function Home({ navigation, setMenuVisible }) {
    ...
    const { session, setSession, langCode, setLangCode, lang, setLang } = useContext(UserContext);
    ...
    const renderButtons = () => {
      ...
      if (session?.user && tutorial===false) {
        return (
